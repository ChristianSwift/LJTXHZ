...
$wtr_HeaderFullwidthNavigation = new WTR_Radio( array(
		'id'			=> 'wtr_HeaderFullwidthNavigation',
		'title'			=> __( 'Full width navigation', 'wtr_framework' ),
		'desc'			=> __( '(This setting may be overridden by single pages)'),
		'value'			=> '',
		'default_value' => '0',
		'info'			=> '',
		'allow'			=> 'int',
...
$wtr_CustomeBodyExtraClassForPage = new WTR_Text(array(
		'id'			=> 'wtr_CustomeBodyExtraClassForPage',
		'class'			=> '',
		'title'			=> __( 'Default Body Extra class name for Page'),
		'desc'			=> __( '(This setting may be overridden by single pages)'),
		'value'			=> '',
		'default_value'	=> '',
		'info'			=> '',
...
$wtr_CustomeBodyExtraClassForPost = new WTR_Text(array(
		'id'			=> 'wtr_CustomeBodyExtraClassForPost',
		'class'			=> '',
		'title'			=> __( 'Default Body Extra class name for Post'),
		'desc'			=> __( '(This setting may be overridden by single psots)'),
		'value'			=> '',
		'default_value'	=> '',
		'info'			=> '',
		'allow'			=> 'all',
...
$wtr_CustomeBodyExtraClassForEvents = new WTR_Text(array(
		'id'			=> 'wtr_CustomeBodyExtraClassForEvents',
		'class'			=> '',
		'title'			=> __( 'Default Body Extra class name for Events'),
		'desc'			=> __( '(This setting may be overridden by single pages)'),
		'value'			=> '',
		'default_value'	=> '',
		'info'			=> '',
...
$wtr_CustomeBodyExtraClassForClasses = new WTR_Text(array(
		'id'			=> 'wtr_CustomeBodyExtraClassForClasses',
		'class'			=> '',
		'title'			=> __( 'Default Body Extra class name for Classes'),
		'desc'			=> __( '(This setting may be overridden by single pages)'),
		'value'			=> '',
		'default_value'	=> '',
		'info'			=> '',
...
$wtr_CustomeBodyExtraClassForRooms = new WTR_Text(array(
		'id'			=> 'wtr_CustomeBodyExtraClassForRooms',
		'class'			=> '',
		'title'			=> __( 'Default Body Extra class name for Rooms'),
		'desc'			=> __( '(This setting may be overridden by single pages)'),
		'value'			=> '',
		'default_value'	=> '',
		'info'			=> '',
...
$wtr_CustomeBodyExtraClassForTrainers = new WTR_Text(array(
		'id'			=> 'wtr_CustomeBodyExtraClassForTrainers',
		'class'			=> '',
		'title'			=> __( 'Default Body Extra class name for Trainers'),
		'desc'			=> __( '(This setting may be overridden by single pages)'),
		'value'			=> '',
		'default_value'	=> '',
		'info'			=> '',
...
$wtr_CustomeCssSection = new WTR_Section( array(
		...
		'fields'	=> array(
			$wtr_CustomeCSS,
			$wtr_CustomeCssCode,
			$wtr_CustomeBodyExtraClassForPage,
			$wtr_CustomeBodyExtraClassForPost,
			$wtr_CustomeBodyExtraClassForEvents,
			$wtr_CustomeBodyExtraClassForClasses,
			$wtr_CustomeBodyExtraClassForRooms,
			$wtr_CustomeBodyExtraClassForTrainers
		 ),
	)
);
