...
if( ! function_exists( 'wtr_public_settings' ) ){
	...
	function wtr_public_settings(){
		...
		global $post, $post_settings, $wtr_date_format, $wtr_post_type;
		...
		if ( ( is_singular( ) AND ! is_attachment() ) OR is_preview() ) {
			...
			if ( 'post' == $wtr_post_type ) {
				...
				$post_settings_single = array(
					...
					'wtr_CustomeBodyExtraClass'		=> '_wtr_CustomeBodyExtraClass',
			...
			// page
				...
				$post_settings_single = array(
					...
					'wtr_HeaderFullwidthNavigation'	=> '_wtr_HeaderFullwidthNavigation'
				);
			}
