...
<div class="ybpjc">
	...
	<ol class="jcbox">
		...
		<li>贴上详细的WordPress方面的教程贴供大家查阅吧！详尽请进【<a href="http://www.xintheme.com/support" target="_blank">GO</a>】</li>
...
function create_dwb_menu() {
  global $wp_admin_bar;
$menu_id = 'dwb';
  $content = wp_remote_retrieve_body( wp_remote_get('http://www.xintheme.com/api?id=22 
